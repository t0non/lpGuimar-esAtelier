        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex w-full sm:w-auto items-center justify-center gap-3 px-8 py-4 rounded-xl font-bold text-[16px] text-white transition-all duration-300 hover:-translate-y-1"
              style={{
            ...
            >
              ...
              Quero produzir com a Guimarães
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-3 px-8 py-4 rounded-xl font-bold text-[16px] transition-all duration-300 hover:-translate-y-1"
              style={{
                backgroundColor: '#FFFFFF',
                color: '#4B5563',
