    ...
    <a
      ...
      onClick={() => {
        if (typeof window !== 'undefined') {
          ...
          dl.push({ event: 'click_cta_floating_whatsapp' });
        }
      }}
      ...
      style={{
        ...
        boxShadow: '0 4px 16px rgba(37,211,102,0.40), 0 2px 8px rgba(0,0,0,0.15)',
      }}
      onMouseEnter={(e) => {
        ;(e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 8px 24px rgba(37,211,102,0.55)'
      }}
      onMouseLeave={(e) => {
        ;(e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 4px 16px rgba(37,211,102,0.40), 0 2px 8px rgba(0,0,0,0.15)'
      }}
    >
