...
const STEPS = [
  {
    ...
    description:
      'Mande o arquivo, a medida desejada e o tipo de aplicação pelo WhatsApp.',
    icon: <SendIcon />,
  },
  {
    number: '02',
    ...
    description:
      'A equipe avalia o material e indica a melhor forma de produzir conforme sua demanda.',
    icon: <ChatIcon />,
  },
  {
    number: '03',
    ...
    description:
      'Você recebe valores, prazo e próximos passos diretamente pelo WhatsApp.',
    icon: <CheckIcon />,
  },
]
